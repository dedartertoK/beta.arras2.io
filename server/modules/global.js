...
global.mothershipletsago = false;
global.disconnected = false;
global.mobile = false;
global.redcaca = false;
global.minimap = [];
global.entities = [];
global.views = [];
global.chats = {};
...
if (c.MOTHERSHIP_LOOP || c.DOMINATOR_LOOP) {
    global.getTeamName1 = team => {
...
if (c.DDAY_LOOP || c.MOTHERSHIP_LOOP || c.DDAYTWO_LOOP || c.DOMINATOR_LOOP) {
    global.getTeamColor = team => [10, 12, 11, 15, 25, 26, 27, 28][-team - 1] || "3 0 1 0 false";
} else {
...
const requires = [
    ...
    "./gamemodes/d-Day_Trenches.js", // D-Day
    "./gamemodes/d-Day_Bastron.js", // D-Day 2
