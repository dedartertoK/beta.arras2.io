const { combineStats, skillSet, makeAuto, makeAuto1, makeDeco } = require('../facilitators.js');
...
exports.destroyerDominatorAI1 = makeAuto1(exports.destroyerDominatorAI, "Destroyer Dominator", {
    size: 0,
});
...
exports.gunnerDominatorAI1 = makeAuto1(exports.gunnerDominatorAI, "Gunner Dominator", {
...
exports.trapperDominatorAI = {
    ...
    CONTROLLERS: ["alwaysFire", "spinWhileIdlemiaow"],
...
exports.trapperDominatorAI1 = makeAuto1(exports.trapperDominatorAI, "Trapper Dominator", {
...
exports.soccerBall = {
    ...
    BODY: {
      ...
      PENETRATION: base.PENETRATION * 0.75,
    ...
    GUNS: (() => {
        ...
        for (let t = 0; t < 16; t++) {
            let S = 22.5 * (t + 1),
                E = {
                    MAX_CHILDREN: 2,
                    SHOOT_SETTINGS: combineStats([g.drone1, g.over1, g.mothership1]),
                    TYPE: "mothershipdrone",
                    AUTOFIRE: true,
                    SYNCS_SKILLS: true,
                    STAT_CALCULATOR: gunCalcNames.drone,
                    WAIT_TO_CYCLE: true,
...
exports.speedy = {
    PARENT: ["genericTank"],
    TOOLTIP: "Please don't escape from arena closer with this tank!",
    LABEL: "GAS GAS GAS",
    LEVEL: 45,
    SKILL: [9,9,9,9,9,9,9,9,9,9],
    BODY: {
    ...
    GUNS: [
        ...
        },
        {
            ...
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.basic, g.flank, g.tri1, g.thruster]),
                TYPE: "bullet",
...
exports.medoingyourmom = {
    ...
    LEVEL: 45,
    STAT_NAMES: {
        BODY_DAMAGE: 'Me doing your mom',
        MAX_HEALTH: 'Me doing your mom',
        BULLET_SPEED: 'Me doing your mom',
        BULLET_HEALTH: 'Me doing your mom',
        BULLET_PEN: 'Me doing your mom',
        BULLET_DAMAGE: 'Me doing your mom',
        RELOAD: 'Me doing your mom',
        MOVE_SPEED: 'Me doing your mom',
        SHIELD_REGEN: 'Me doing your mom',
        SHIELD_CAP: 'Me doing your mom',
    },
    BODY: {
    ...
    GUNS: [
        {
            POSITION: [112, 8.5, 1, 0, 0, 0, 0],
            PROPERTIES: {
                SHOOT_SETTINGS: combineStats([g.speedo2]),
                TYPE: "bullet",
            },
        },
        {
...
exports.meonmywaytodoyourmom = {
    ...
    STAT_NAMES: {
        BODY_DAMAGE: 'Me on my way to do your mom',
        MAX_HEALTH: 'Me on my way to do your mom',
        BULLET_SPEED: 'Me on my way to do your mom',
        BULLET_HEALTH: 'Me on my way to do your mom',
        BULLET_PEN: 'Me on my way to do your mom',
        BULLET_DAMAGE: 'Me on my way to do your mom',
        RELOAD: 'Me on my way to do your mom',
        MOVE_SPEED: 'Me on my way to do your mom',
        SHIELD_REGEN: 'Me on my way to do your mom',
        SHIELD_CAP: 'Me on my way to do your mom',
    },
...
exports.machineshot = {
    ...
    DANGER: 7,
    LEVEL: 45,
    TOOLTIP: "Lagging the server with this tank will permanently delete your token.",
    SKILL: [9, 9, 9, 9, 9, 9, 9, 9, 9, 9],
    BODY: {
      FOV: 1,
      SPEED: base.SPEED * 1,
  ...
  exports.arenaCloserMain = {
    ...
    GUNS: [{
        ...
        PROPERTIES: {
            SHOOT_SETTINGS: combineStats([g.basic, g.closer1]),
...
exports.TwinCloser = {
    ...
    GUNS: [
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.arenabullet4]),
          TYPE: ["bullet", { LAYER: 12 } ]
        },
      },
      {
        ...
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.arenabullet4, g.twin, g.basic]),
          TYPE: ["bullet", { LAYER: 12 } ]
        },
      },
    ],
  ...
  exports.FlameCloser = {
    ...
    GUNS: [
      {
        /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [23, 2, 1.4, 7, 0, 0, 8],
      },
      {
        POSITION: [12, 10, 1.4, 8, 0, 0, 0],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.mach, g.arenabullet3]),
          TYPE: ["bullet", { LAYER: 12 } ]
        },
      },
    ],
    ...
    GUNS: [
      {
        ...
        POSITION: [12, 10, 1.4, 8, 0, 0, 0],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.mach, g.arenabullet4]),
          TYPE: ["bullet", { LAYER: 12 } ]
        },
      },
    ],
  ...
  exports.Penta_Closer = {
    ...
    GUNS: [
      {
        /*** LENGTH  WIDTH   ASPECT    X       Y     ANGLE   DELAY */
        POSITION: [11, 8, 1, 0, -3, -30, 0.667],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([g.basic, g.twin, g.bent, g.arenabullet4]),
          TYPE: ["bullet", { LAYER: 12 } ]
        },
      },
      {
  ...
  exports.redistributor_closer = {
    PARENT: ["genericTank"],
    LABEL: "Redistributor Closer",
    SIZE: 34,
    COLOR: 3,
    CAN_GO_OUTSIDE_ROOM: true,
    LEVEL: 45,
    ...
    GUNS: [
      {
        POSITION: [7.25, 12.25, 1.25, 10, 0, 0, 0.75],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.basic,
            g.redistributor2,
          ...
          TYPE: ["redistributorBullet", { LAYER: 12 } ],
        },
      },
      {
        POSITION: [18.5, 12, 1, 0, 0, 0, 0.09375],
        PROPERTIES: {
          SHOOT_SETTINGS: combineStats([
            g.basic,
            g.redistributor2,
          ...
          TYPE: ["redistributorBullet", { LAYER: 12 } ], //WAIT_TO_CYCLE: true
        },
      },
      {
...
exports.antiTankMachineDestroyer = {
    PARENT: ["dominator"],
    LABEL: "Anti Tank Machine Destroyer",
    CONTROLLERS: [['spin', {onlyWhenIdle: true}], 'nearestDifferentMaster'],
    LEVEL: 45,
    SIZE: 50,
    BODY: {
...
exports.antiTankMachineGunArm1 = {
    PARENT: ["genericTank"],
    CONTROLLERS: ["mapTargetToGoal"],
    SKILL_CAP: Array(10).fill(255),
    SKILL: Array(10).fill(255),
...
exports.antiTankMachineArenaCloser = {
    PARENT: ["dominator"],
    LABEL: "Anti Tank Machine Arena Closer",
    CONTROLLERS: [['spin', {onlyWhenIdle: true}], 'nearestDifferentMaster'],
    LEVEL: 45,
    SIZE: 50,
    COLOR: 3,
...
exports.antiTankMachineGunArm2 = {
    PARENT: ["genericTank"],
    CONTROLLERS: ["mapTargetToGoal"],
    SKILL_CAP: Array(10).fill(255),
    SKILL: Array(10).fill(255),
