const { combineStats, addAura, makeAuto1 } = require('../facilitators.js');
...
exports.developer = {
    PARENT: ["menu"],
    TOOLTIP: "Please do not abuse these tanks.",
    LABEL: "Developer",
...
exports.bosses = {
    PARENT: ["menu"],
    LABEL: "Bosses",
    TOOLTIP: "To control those bosses except sentries, use your mouse to move instead of your keyboard. Don't forget to enable autofire!",
};
exports.sentries = {
    PARENT: ["menu"],
    LABEL: "Sentries",
...
exports.antiMachineTanks = {
    PARENT: ["menu"],
    LABEL: "Anti Machine Tanks",
    COLOR: 12,
    TURRETS: [
        {
            POSITION: [22, 0, 0, 0, 360, 0],
...
exports.trapssanctuariesAI1 = makeAuto1(exports.trapssanctuariesAI, "Sanctuary", {

    size: 0,
});
exports.destroyerDominatorsancsAI = {
    PARENT: ["dominator"],
    SIZE: 50,
    DANGER: 7,
    BODY: {
...
exports.destroyerDominatorsancsAI1 = makeAuto1(exports.destroyerDominatorsancsAI, "Sanctuary", {
...
exports.auraHealerGen1 = addAura(-1);
exports.auraHealer = {
    PARENT: ["genericTank"],
    LABEL: "Aura Healer",
    TURRETS: [
...
exports.randomTankTemp = {
    ...
    GUNS : [
    /* {
    POSITION: [ 26.4, 8.5, 0.9, 13, 0, 0, 0],
    PROPERTIES: {
    SHOOT_SETTINGS: combineStats([ g.drone, g.gunner, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.battle, g.carrier]),
    TYPE: "drone",
    AUTOFIRE: true,
    SYNCS_SKILLS: true,
    ...
    POSITION: [ 23.4, 8.5, 0.9, 6.5, 2, 15, 1/2 ],
    PROPERTIES: {
    SHOOT_SETTINGS: combineStats([ g.drone, g.sniper, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.bent, g.twin]),
    TYPE: "drone",
    AUTOFIRE: true,
    SYNCS_SKILLS: true,
    STAT_CALCULATOR: gunCalcNames.drone,
    MAX_CHILDREN: 4,
    // dam: 1.89, str: 0.243, pen: 1.056, rld: 464062500
    }, },{
    POSITION: [ 23.4, 8.5, 0.9, 6.5, -2, -15, 0/2 ],
    PROPERTIES: {
    SHOOT_SETTINGS: combineStats([ g.drone, g.sniper, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.twin, g.bent]),
    TYPE: "drone",
    AUTOFIRE: true,
    SYNCS_SKILLS: true,
    STAT_CALCULATOR: gunCalcNames.drone,
    ...
    POSITION: [ 26.4, 8.5, 0.9, 13, 0, 0, 0/2 ],
    PROPERTIES: {
    SHOOT_SETTINGS: combineStats([ g.drone, g.sniper, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.blank, g.bent, g.twin]),
    TYPE: "drone",
    AUTOFIRE: true,
...
exports.developer.UPGRADES_TIER_0 = ["tanks", "bosses", "tools", "addons"];
	...
	exports.specialTanks.UPGRADES_TIER_0 = ["arenaClosers", "bases", "mothership"];
    exports.arenaClosers.UPGRADES_TIER_0 = ["arenaCloserMain","TwinCloser", "FlameCloser", "Penta_Closer", "Machine_Closer", "arenaCloser", "Booster_Closer", "redistributor_closer", "antiTankMachineArenaCloser"];
        exports.bases.UPGRADES_TIER_0 = ["baseProtector", "dominators", "sanctuaries", "antiMachineTanks"];
        exports.antiMachineTanks.UPGRADES_TIER_0 = ["antiTankMachineGun","antiTankMachineDestroyer", "antiTankMachineArenaCloser"];
                exports.dominators.UPGRADES_TIER_0 = ["dominator", "destroyerDominator", "gunnerDominator", "trapperDominator"];
                exports.sanctuaries.UPGRADES_TIER_0 = ["trapssanctuaries"];
        ...
        exports.funTanks.UPGRADES_TIER_0 = ["florr_tank", "vanquisher", "armyOfOne", "godbasic", "maximumOverdrive", "mummifier", "auraBasic", "auraHealer", "weirdAutoBasic", "ghoster", "switcheroo", "tracker3", "speedy", "machineshot","meonmywaytodoyourmom","page2"];
        exports.page2.UPGRADES_TIER_0 = ["medoingyourmom","bigballs", "digger", "randomTankTemp"];
    ...
    exports.bosses.UPGRADES_TIER_0 = ["sentries", "elites", "mysticals", "nesters", "rogues", "terrestrials", "celestials", "eternals", "devBosses", "fallenBosses"];
    exports.fallenBosses.UPGRADES_TIER_0 = ["fallenBooster"];
