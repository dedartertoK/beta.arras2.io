            ...
            case global.KEY_SHIFT:
                ...
                break;
                    case global.KEY_ENTER:
                        ...
                        // Disable Enter functionality when arena is closed
                        if (global.arenaClosed) {
                            // Do nothing or handle it as needed when the arena is closed
                            // You can also add a message or log to indicate that Enter is disabled
                            return 1;
                        }
                        ...
                        // Check if disconnected flag is false and not connecting
                        if (!global.disconnected) {
                        ...
                        // Handle other cases for KEY_ENTER as needed
                        break;
